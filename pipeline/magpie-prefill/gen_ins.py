...
def get_args():
    ...
    parser.add_argument("--total_prompts", type=int, default=20000, help="Total number of prompts to generate. If specified, repeat will be ignored.")
    ...
    parser.add_argument("--checkpoint_every", type=int, default=50, help="Save checkpoint every n repeats.")
...
def main():
    ...
    output_filename = f"Prefill_{args.model_path.split('/')[-1]}_{args.total_prompts}_{args.timestamp}_ins.json"
        ...
        for i, completion in enumerate(output_list):
            ...
            if args.sanitize:
                ...
                result = {
                    "id": rounds * args.n + i,
                    "pre_query_template": f"{pre_query_template}",
                    "instruction": "Write a python function to " + instruction,
                    "response": None,
                    "created": int(time.time()),
                    "gen_input_configs": {
                        "temperature": args.temperature,
